          ...
          <form action="/admin/addUser" method="post" id="addUserForm">
              ...
              <div class="form-group form-multi">
                ...
                <div class="form-multi-body">
                  <?php $__currentLoopData = $rankList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rankID => $rankName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="sub-form-group">
                    <input type="radio" name="rank" id="add-rank<?php echo e($rankID); ?>" value="<?php echo e($rankID); ?>">
                    <label for="add-rank<?php echo e($rankID); ?>"><?php echo e($rankName); ?></label>
                  </div>
              ...
              <div class="form-group form-multi form-grid">
                ...
                <div class="form-multi-body form-grid-body">
                  ...
                  <div class="sub-form-group">
                    <input type="checkbox" name="organization[]" id="add-org<?php echo e($organizationID); ?>" value="<?php echo e($organizationID); ?>">
                    <label for="add-org<?php echo e($organizationID); ?>"><?php echo e($organizationName); ?></label>
                  </div>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
              </div>
          ...
          <form action="/admin/editUser" method="post" id="editUserForm">
              ...
              <div class="form-group form-multi">
                ...
                <div class="form-multi-body">
                  <?php $__currentLoopData = $rankList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rankID => $rankName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="sub-form-group">
                    <input class="editUserForm_rank" type="radio" name="rank" id="edit-rank<?php echo e($rankID); ?>" value="<?php echo e($rankID); ?>">
                    <label for="edit-rank<?php echo e($rankID); ?>"><?php echo e($rankName); ?></label>
                  </div>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
              </div>
              ...
              <div class="form-group form-multi form-grid">
                ...
                <div class="form-multi-body form-grid-body">
                  <?php $__currentLoopData = $organizationList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $organizationID => $organizationName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="sub-form-group">
                    <input class="editUserForm_organization" id="edit-org<?php echo e($organizationID); ?>" type="checkbox" name="organization[]" value="<?php echo e($organizationID); ?>">
                    <label for="edit-org<?php echo e($organizationID); ?>"><?php echo e($organizationName); ?></label>
                  </div>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
              </div>
          ...
          <form id="filterForm">
            ...
            <div class="form-group form-multi">
              ...
              <div class="form-multi-body">
                <?php $__currentLoopData = $rankList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rankID => $rankName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="sub-form-group">
                  <input type="checkbox" name="rankFilter" id="filter-rank<?php echo e($rankID); ?>" value="<?php echo e($rankID); ?>">
                  <label for="filter-rank<?php echo e($rankID); ?>"><?php echo e($rankName); ?></label>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </div>
            </div>
            ...
            <div class="form-group form-multi form-grid">
              ...
              <div class="form-multi-body form-grid-body">
                <?php $__currentLoopData = $organizationList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $organizationID => $organizationName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="sub-form-group">
                  <input type="checkbox" id="filter-org<?php echo e($organizationID); ?>" name="organizationFilter" value="<?php echo e($organizationID); ?>">
...
<?php /**PATH D:\Code Project\Printer Room System\PrinterRoomSystem\resources\views/admin/admin.blade.php ENDPATH**/ ?>