  ...
  <body>
    ...
    <form action="/" method="post" onsubmit="return formCheck()">
      ...
      <div class="error-layout">
        <div class="error-box"><?php echo e($formError); ?></div>
      </div>
      <?php endif; ?>
...
<?php $__currentLoopData = $organizationList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx=>$organization): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <input type="radio" name="org" id="org<?php echo e($idx+1); ?>" value="<?php echo e($idx+1); ?>" />
          <label for="org<?php echo e($idx+1); ?>"><?php echo e($organization); ?></label>
...
<?php /**PATH D:\Code Project\Printer Room System\PrinterRoomSystem\resources\views/index.blade.php ENDPATH**/ ?>